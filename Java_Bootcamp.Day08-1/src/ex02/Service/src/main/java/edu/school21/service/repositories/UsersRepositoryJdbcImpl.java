...
public class UsersRepositoryJdbcImpl implements UsersRepository<User> {
    ...
    public Optional<User> findById(Long id) {
        ...
        Optional<User> result = Optional.empty();
        try (Connection connection = dataSource.getConnection();
                PreparedStatement statement = connection.prepareStatement("SELECT id, email, password FROM users WHERE id = ?")) {
    ...
    public List<User> findAll() {
        ...
        try(Connection connection = dataSource.getConnection();
                PreparedStatement statement = connection.prepareStatement("SELECT id, email, password FROM users")) {
            try (ResultSet resultSet = statement.executeQuery()) {
